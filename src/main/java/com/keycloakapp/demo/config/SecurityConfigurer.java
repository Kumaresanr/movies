...
// wird behoben im Kontext Keycloak 5.X.Y.Final
//@KeycloakConfiguration
@Configuration
@ComponentScan({"com.keycloakapp.demo.controller"})
@ComponentScan(
...
public class SecurityConfigurer extends KeycloakWebSecurityConfigurerAdapter {
    ...
    public SecurityConfigurer(KeycloakClientRequestFactory keycloakClientRequestFactory) {
    ...
    /**
     * Sets keycloaks config resolver to use springs application-local.properties instead of keycloak.json (which is standard)
     * @return
     */
    @Bean
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        ...
        http.cors()
                ...
                .and()
                    .authorizeRequests().antMatchers("/movie/*").hasRole("user")
